...
@Configuration
@EnableMongoRepositories("pl.virtual.library.dropbox.ports.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("pl.virtual.library.dropbox.ports.config.dbmigrations");
