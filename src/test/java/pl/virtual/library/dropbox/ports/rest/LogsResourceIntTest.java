package pl.virtual.library.dropbox.ports.rest;

import pl.virtual.library.dropbox.VirtualLibraryDropboxApp;
import pl.virtual.library.dropbox.ports.rest.vm.LoggerVM;
...
@SpringBootTest(classes = VirtualLibraryDropboxApp.class)
